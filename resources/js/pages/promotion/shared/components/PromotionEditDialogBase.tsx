...
import type { Product, Promotion } from "@/pages/promotion/shared/types";
...
export default function PromotionEditDialogBase({
  isOpen,
  onOpenChange,
  promotion,
  permissionPrefix,
  ...
  useEffect(() => {
    if (isOpen) {
      // Exception autorisée par les patterns: chargement dynamique de données via API
      fetch('/api/products')
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    put(route(`${routePrefix}.update`, { promotion: promotion.id }), {
      onSuccess: () => {
